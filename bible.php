...
if (isset($_POST['submit'])) {
    ...
    // Validate form data
    if (empty($hostel_name) || empty($speaker_name) || empty($topic) || empty($std_count) || empty($date) || empty($day)  || empty($type)) {
        ...
        $sql = "INSERT INTO Sample (hostel_name, speaker_name, topic, std_count, date, day, type) VALUES (?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssisss", $hostel_name, $speaker_name, $topic, $std_count, $date, $day, $type);
